  ...
  \cventry
    ...
    {Aug. 2016 - Dec. 2016} % Date(s)
    {
      \begin{cvitems} % Description(s)
        ...
        \item {The system and all inclusive components were presented with a \emph{systems engineering plan (SEP)}.}
      \end{cvitems}
    }
...
%---------------------------------------------------------
  \cventry
    ...
    {
      \begin{cvitems} % Description(s)
        \item {By creating a specialized mask via \emph{photolithography} to create a master on a silicone wafer, a \emph{bioMEMs} device was produced from poly(dimethylsiloxane) that contained a mucrofluidic system for cell sorting. Key efficiency parameters were analyzed to optimize the micro-device even further.}
        \item {Learned about \emph{wafer fabrication} and the process of creating bioMEMs to improve healthcare.}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {Aug. 2015 - May 2016} % Date(s)
    {
      \begin{cvitems} % Description(s)
        ...
        \item {This system was designed to speed up \emph{simultaneous MRI/PET} image acquisition in mouse studies, to improve imaging throughput.}
      \end{cvitems}
    }
